...
///Данный код на языке программирования C# представляет собой реализацию алгоритма сдвига тональности аудио с помощью преобразования Фурье. Класс SMBPitchShifter содержит метод
///PitchShift, который принимает параметры сдвига тональности, количество образцов для обработки, размер фрейма преобразования Фурье и другие параметры, а также входные аудио данные
///в виде массива indata. Метод выполняет сдвиг тональности аудио и записывает результат в выходной массив outdata.

///Данный код использует некоторые математические вычисления, такие как вычисление магнитуды и фазы, применение окна, преобразование Фурье и обратное преобразование Фурье. Он также
///содержит некоторые вспомогательные методы, такие как ShortTimeFourierTransform, которые выполняют преобразование Фурье.
